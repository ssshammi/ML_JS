...
for(var i=0;i<finalResults.length;i++){
	if(finalResults[i]==Ytest.data[i])
	 {
	 	count=count+1
	 }
};
...
console.log(Ytest.data.toString().split(",")); 
const CM2 = ConfusionMatrix.fromLabels(Ytest.data.toString().split(","), finalResults.toString().split(","));
console.log(CM2.matrix); 
